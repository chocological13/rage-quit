...
const ProdBanner: React.FC = () => {
  return (
    <div className="hero-bg bg-fill relative flex h-[820px] flex-row overflow-hidden bg-slate-600 bg-opacity-60 bg-[url('/banner/prod-banner-mobile.webp')] bg-cover bg-center bg-no-repeat py-20 bg-blend-soft-light md:bg-[url('/banner/prod-banner.webp')]">

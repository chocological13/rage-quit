  ...
  return (
    <div className="team-text text-center text-lg tracking-wide text-slate-600 md:text-2xl">
      <p>
        ...
        the boundaries of innovation and deliver unforgettable experiences. From
        visionary leaders and creative minds to technical wizards and community
        champions, our diverse team collaborates seamlessly to turn dreams into
        reality.
        <br />
        <br />
        <span className="text-2xl font-light md:text-4xl">
          Get to know the dedicated individuals who make RageQuit Games a leader
